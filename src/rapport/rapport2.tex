...
Nous avons abordé le projet en travaillant tous ensemble a la compréhension des consignes et des differents fichiers : les fichiers de la grammaire lex et bison.\\
...
\item ITEM :   item a posé la question des petits points, vite résolue.
...
La table des contenus fut difficile à implémenter, deja il fallait mettre des balises pour que les sections dans la table nous amènent directement aux sections, ensuite il a fallu écrire a chaque section / sous section croisée a la fois dans le fichier html et dans un autre qui sert de table de contenus, puis au final a l'aide de plusieurs dup2 fopen et fflush venir 
