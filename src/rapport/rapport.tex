...
\begin{itemize}
\item Pouvoir cliquer sur les définitions de fonctions pour allez sur la documentation (on peut pour le moment cliquer sur les déclarations pour allez au niveau de la définition)
