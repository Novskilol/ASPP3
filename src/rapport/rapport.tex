...
\end{itemize}
\\
L'utilisation de notre parseur C sur l'intégralité de nos fichiers (excepté les fichiers bison, flex, et javascript) provoque cependant 3 erreurs de syntaxes.
\\
En isolant la fonction causant ces erreurs, l'erreur de syntaxe disparait. Nous n'avons à ce jour pas réussi à cerner d'où pourrait provenir le bug causant ces erreurs.
